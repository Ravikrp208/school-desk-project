...
} catch (PDOException $e) { echo "student_ratio: " . $e->getMessage() . "<br>"; }
...
} catch (PDOException $e) { echo "security_info: " . $e->getMessage() . "<br>"; }
...
} catch (PDOException $e) { echo "curriculum_info: " . $e->getMessage() . "<br>"; }
...
} catch (PDOException $e) { echo "medical_aid: " . $e->getMessage() . "<br>"; }
